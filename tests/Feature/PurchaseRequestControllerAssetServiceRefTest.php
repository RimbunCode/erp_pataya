...
class PurchaseRequestControllerAssetServiceRefTest extends TestCase {
    use RefreshDatabase;
    ...
    public function test_create_with_asset_service_ref_prefills_items_from_consumed_items(): void {
        ...
        $response = $this->actingAs($user)
            ...
            ->get(route('purchaseRequests.create', ['ref' => "assetService/{$assetService->id}"]));
    ...
    public function test_create_with_invalid_asset_service_ref_returns_empty_form(): void {
        ...
        $response = $this->actingAs($user)
            ->withSession($this->permissions())
            ->get(route('purchaseRequests.create', ['ref' => 'assetService/nonexistent']));
