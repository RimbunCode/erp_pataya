...
return new class extends Migration
{
    ...
    public function up(): void {
        Schema::table('purchase_invoices', function (Blueprint $table) {
            ...
            // Faktur Pajak Masukan: nomor seri diterbitkan oleh supplier (dicatat, bukan
            // digenerate sistem ini) -- beda semantik dengan SalesInvoice (Faktur Keluaran,
            // sistem ini yang menerbitkan). Tetap unique karena satu nomor seri = satu faktur.
