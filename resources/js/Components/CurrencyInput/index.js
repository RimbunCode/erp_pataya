(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd
      ...
      : ((global =
        ...
        factory((global.ReactCurrencyInputField = {}), global.React));
  ...
  ***************************************************************************** */
  ...
  var parseAbbrValue = function (value, decimalSeparator) {
    ...
    var reg = new RegExp(
      "(\\d+(".concat(escapeRegExp(decimalSeparator), "\\d*)?)([kmb])$"),
      "i",
    );
  ...
  var cleanValue = function (_a) {
    ...
    var _k = RegExp("(\\d+)-?".concat(escapeRegExp(prefix))).exec(value) || [],
    ...
    var withoutInvalidChars = removeInvalidChars(
      withoutSeparators,
      __spreadArray([groupSeparator, decimalSeparator], abbreviations, true),
    );
  ...
  var fixedDecimalValue = function (
    value,
    decimalSeparator,
    fixedDecimalLength,
  ) {
  ...
  var formatValue = function (options) {
    ...
    var _c = intlConfig || {},
      ...
      formatOptions = __rest(_c, ["locale", "currency"]);
    var defaultNumberFormatOptions = __assign(__assign({}, formatOptions), {
    ...
    var numberFormatter = intlConfig
      ? new Intl.NumberFormat(
          locale,
          __assign(
            __assign({}, defaultNumberFormatOptions),
    ...
    var includeDecimalSeparator =
      _value.slice(-1) === decimalSeparator ? decimalSeparator : "";
    var _d = value.match(RegExp("\\d+\\.(\\d+)")) || [],
      decimals = _d[1];
    ...
    if (decimalScale === undefined && decimals && decimalSeparator) {
      if (formatted.includes(decimalSeparator)) {
        formatted = formatted.replace(
          RegExp(
            "(\\d+)(".concat(escapeRegExp(decimalSeparator), ")(\\d+)"),
            "g",
          ),
          "$1$2".concat(decimals),
        );
        ...
        if (intlSuffix && !suffix) {
          formatted = formatted.replace(
            intlSuffix,
            "".concat(decimalSeparator).concat(decimals).concat(intlSuffix),
          );
        } else {
          formatted = ""
            .concat(formatted)
  ...
  var getLocaleConfig = function (intlConfig) {
    var _a = intlConfig || {},
      ...
      formatOptions = __rest(_a, ["locale", "currency"]);
    var numberFormatter = locale
      ? new Intl.NumberFormat(
          locale,
          __assign(
            __assign({}, formatOptions),
            currency && { currency: currency, style: "currency" },
          ),
        )
      : new Intl.NumberFormat();
    return numberFormatter.formatToParts(1000.1).reduce(function (
      prev,
      curr,
      i,
    ) {
  ...
  var padTrimValue = function (value, decimalSeparator, decimalScale) {
    ...
    return numberFormatter
      .format(parseFloat(stringValueWithoutSeparator))
      .replace(/,/g, "");
  };
  ...
  var CurrencyInput = React.forwardRef(function (_a, ref) {
    var _b = _a.allowDecimals,
      ...
      formatValueOnBlur = _g === void 0 ? true : _g,
      props = __rest(_a, [
        "allowDecimals",
        "allowNegativeValue",
        "id",
    ...
    var localeConfig = React.useMemo(
      function () {
    ...
    var placeholder =
      _placeholder !== null && _placeholder !== void 0
        ? _placeholder
        : formatValue(
    ...
    var handleOnBlur = function (event) {
      ...
      var fixedDecimals = fixedDecimalValue(
        valueOnly,
        decimalSeparator,
        fixedDecimalLength,
      );
      var newValue = padTrimValue(
        fixedDecimals,
        decimalSeparator,
      ...
      var formattedValue = formatValue(
        __assign(__assign({}, formatValueOptions), { value: newValue }),
      );
    ...
    var handleOnKeyDown = function (event) {
      ...
      if (step && (key === "ArrowUp" || key === "ArrowDown")) {
        ...
        var stringValueWithoutSeparator =
        ...
        var currentValue =
          parseFloat(
            stringValueWithoutSeparator != null
              ...
              : cleanValue(__assign({ value: stateValue }, cleanValueOptions)),
          ) || 0;
        var newValue =
