  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="flex h-7 shrink-0 cursor-pointer items-center gap-1.5 rounded-md border border-input px-1.5 text-sm font-medium text-primary outline-none transition-colors hover:bg-accent [&>svg]:size-4"
        >
