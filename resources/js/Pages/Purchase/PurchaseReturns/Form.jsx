...
export default function Form() {
    ...
    return [
      {
        name: "item",
        readOnly: true,
        titleTrans: "purchase.purchaseReturn.columns.item",
        required: true,
        width: 2,
        cell({ dataRow, setData, attributes }) {
          return (
            <ItemVariantLinkModel
              placeholder={t(
                "purchase.purchaseReturn.columns.item.placeholder",
              )}
              value={dataRow.item}
              onValueChange={(val) => {
                setData({
      ...
      {
        name: "description",
        titleTrans: "purchase.purchaseReturn.columns.description",
        show: false,
        type: "text",
        width: 2,
      ...
      data.type == "replace" && {
        ...
        titleTrans: "purchase.purchaseReturn.columns.source_warehouse",
        show: true,
        type: "text",
        width: 2,
        required: true,
        cell({ dataRow, data, setData, attributes }) {
          return (
            <WarehouseLinkModel
              disabled={!dataRow?.item}
              placeholder={t(
                "purchase.purchaseReturn.columns.source_warehouse.placeholder",
              )}
              value={data}
      ...
      },
      {
        ...
        titleTrans: "purchase.purchaseReturn.columns.target_warehouse",
        show: true,
        type: "text",
        width: 2,
        required: true,
        cell({ dataRow, data, setData, attributes }) {
          return (
            <WarehouseLinkModel
              disabled={!dataRow?.item}
              placeholder={t(
                "purchase.purchaseReturn.columns.target_warehouse.placeholder",
              )}
              value={data}
      ...
      {
        name: "quantity",
        titleTrans: "purchase.purchaseReturn.columns.quantity",
        required: true,
        type: "number",
        width: 1,
        cell({ dataRow, data, setData, attributes }) {
      ...
      },
      {
        name: "unit",
        readOnly: true,
        titleTrans: "purchase.purchaseReturn.columns.unit",
        required: true,
        cell({ data, setData, attributes, dataRow }) {
          return (
            <UnitLinkModel
              disabled={!dataRow?.item}
              placeholder={t(
                "purchase.purchaseReturn.columns.unit.placeholder",
              )}
              value={data}
  ...
  return (
    <>
      <FormPageContent
        value="detail"
        title={t("purchase.purchaseReturn.detail")}
      >
        <div className="grid gap-x-4 gap-y-4 md:grid-cols-2">
          <FormInput
            name="return_date"
            label={t("purchase.purchaseReturn.columns.return_date")}
            required
          >
            <DatetimePicker
              type="datetime"
          ...
          <FormInput
            label={t("purchase.purchaseReturn.columns.delivery_note")}
            required={true}
            name="delivery_note"
          >
            <DeliveryNoteLinkModel
              placeholder={t(
                "purchase.purchaseReturn.columns.delivery_note.placeholder",
              )}
              with={[
                "items",
          ...
          <FormInput
            label={t("purchase.purchaseReturn.columns.type")}
            required
            name="type"
          >
            <Select
              placeholder={t(
                "purchase.purchaseReturn.columns.type.placeholder",
              )}
              optionTrans="purchase.purchaseReturn.columns.type.options"
      ...
      <FormPageContent
        value="detail"
        title={t("purchase.purchaseReturn.columns.external_note")}
        collapsible
