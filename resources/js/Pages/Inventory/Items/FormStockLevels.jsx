        ...
        <div className="grid text-sm grid-cols-[3fr_1fr_1fr_auto] [&>*]:px-4 ">
          {stocks?.map((stock) => (
            ...
            >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="pr-0.5 flex flex-col items-end justify-center border-r border-muted-foreground/25 ">
                    <span className="px-1 text-xs">{stock.reserved_stock}</span>
                    <span
                      className={cn(
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="pl-0.5 flex flex-col items-start justify-center">
                    <span className="px-1 text-xs">{stock.actual_stock}</span>
                    <span
                      className={cn(
                        "rounded-r-full h-1.5 ",
                        stock.actual_stock == 0 ? "bg-muted" : "bg-foreground",
                      )}
                      style={{
                        width:
              ...
              <span className="px-2 ml-6 text-center">{stock.total_stock}</span>
            </div>
          ))}
        </div>
      </WhenVisible>
