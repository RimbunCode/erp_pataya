...
export default function Index({ lang }) {
  ...
  const columns = useMemo(
    () => [
      {
        titleTrans: "finances.taxes.columns.name",
        name: "name",
        searchType: "text",
        sortable: true,
        resizeable: true,
      ...
      {
        titleTrans: "finances.taxes.columns.rate",
        name: "rate",
        searchType: "number",
        sortable: true,
        resizeable: true,
  ...
  return (
    <>
      <DataTable
        ...
        title={t("finances.taxes.title")}
        addButton={{
          title: t("finances.taxes.add_category"),
          onClick: () => {
            setShowNewForm(true);
          },
        }}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t("finances.taxes.delete")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("finances.taxes.delete.description")}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            >
              {t("finances.taxes.delete.confirm")}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
