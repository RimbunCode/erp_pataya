      ...
      <div className="p-8 flex flex-col gap-8">
        ...
        <div className="flex items-center gap-6">
          <div className="relative flex-shrink-0">
            <div className="w-24 h-24 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 flex items-center justify-center text-gray-300 cursor-pointer hover:border-blue-400 hover:bg-blue-50 hover:text-blue-400 transition-all duration-200">
              <svg
                className="w-8 h-8"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <div>
            <h2 className="text-2xl font-black text-gray-600 uppercase tracking-tight">
              {user?.name ?? "Ahmad Faisal"}
            </h2>
            <p className="text-xs font-extrabold tracking-widest text-blue-500 uppercase mt-1">
              Student Account
            </p>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                value={form.email}
                onChange={handleChange}
                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-600 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white hover:border-gray-300 shadow-md transition-all"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-600 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all resize-none"
            />
          </div>
        </div>
