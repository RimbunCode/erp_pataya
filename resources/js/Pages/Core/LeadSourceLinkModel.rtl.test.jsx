...
describe("LeadSourceLinkModel", () => {
  beforeEach(() => {
    ...
    // "sessionStorage" (lihat LeadSourceLinkModel.jsx baris 16-17). Beda dari
    // wrapper LinkModel lain yang di-test tanpa cache (NumberCardLinkModel,
    // AssetLocationLinkModel dst): saat cacheConfig.enabled, LinkModel.jsx
    // (baris ~406-420) SELALU meng-invalidasi (removeCache) key sessionStorage
    // yang sama tepat sebelum effect pembaca cache berikutnya sempat
    // membacanya (race disengaja di implementasi asli, race window ini bukan
    // milik LeadSourceLinkModel), sehingga tiap mount SELALU fetch ulang dari
    // axios (payload cacheMode:true) terlepas dari isi sessionStorage
    // sebelumnya. clear() di sini murni utk higiene test, bukan prasyarat
    // supaya lulus.
