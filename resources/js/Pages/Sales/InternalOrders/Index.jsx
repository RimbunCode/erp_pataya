...
export default function Index({ lang }) {
  ...
  const columns = useMemo(
    () => [
      {
        titleTrans: "sales.internalOrder.columns.io",
        name: "code",
        searchType: "text",
        sortable: true,
        resizeable: true,
        cell: ({ dataRow }) => (
          <Link
            ...
            href={route("internalOrder.show", dataRow.id)}
          >
            {dataRow.code}
          </Link>
        ),
      ...
      {
        titleTrans: "sales.internalOrder.columns.date",
        name: "date",
        searchType: "date",
        sortable: true,
        resizeable: true,
      ...
      {
        titleTrans: "sales.internalOrder.customer",
        name: "customer_name",
        searchType: "text",
        sortable: true,
        resizeable: true,
      ...
      {
        titleTrans: "sales.internalOrder.columns.shipped",
      ...
      {
        titleTrans: "sales.internalOrder.status",
        name: "status",
        searchType: "text",
        sortable: true,
        width: "fit",
  ...
  return (
    <>
      <DataTable
        ref={tableRef}
        title={t("sales.internalOrder.title")}
        addButton={{
          title: t("sales.internalOrder.addButton"),
          onClick: () => {
            setShowNewForm(true);
          },
        }}
          ...
          <div className="flex items-center justify-between p-4 border-b gap-x-4 border-muted-foreground/25">
            ...
            >
              <p className="text-base font-medium text-left text-muted-foreground">
                {t(`sales.internalOrder.types.${dataRow.type}`)}
              </p>
