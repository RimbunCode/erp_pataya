...
function AlertCard({ label, count, description, accentClass }) {
  ...
  return (
    <div
      className={`rounded-2xl border px-5 py-4 flex items-center justify-between gap-4 ${accentClass}`}
    >
      <div>
...
export default function AdminDashboard({
  ...
  return (
    <MainLayout>
      <div
        data-role="admin"
        className="p-8 space-y-6 h-full bg-[var(--background)]"
      >
        {/* Header */}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="shrink-0 text-right">
                            ...
                            <span
                              className={`inline-block mt-1 px-2 py-0.5 rounded text-[10px] font-bold ${cfg.pill}`}
                            >
                              {cfg.label}
                            </span>
                          </div>
