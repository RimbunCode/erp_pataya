...
export default function ProfileSettings({ user, profile }) {
  ...
  const handleSubmit = () => {
    router.put(route("admin.profile.update"), form);
  };
  ...
  const accountRoleLabel =
    roleNames.length > 0 ? roleNames.join(", ") : "Admin";
  ...
  return (
    <MainLayout title="Profile Settings" breadcrumb="Profile">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="destructive" size="icon" asChild>
                      <Link href={route("admin.image.delete")} method="delete">
      ...
      <UploadDialog
        ...
        imageOnly
        options={{
          route: route("admin.avatar.update"),
        }}
      />
    </MainLayout>
  );
