# Graph Report - erp  (2026-08-06)

## Corpus Check
- 1540 files · ~894,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10869 nodes · 19660 edges · 995 communities (742 shown, 253 thin omitted)
...
## Communities (995 total, 253 thin omitted)

### Community 0 - "Illuminate\Notifications\Notification"
Cohesion: 0.04
Nodes (29): AttachGeneratedPdfJob, SendNotificationMailJob, ReplayHaveTransactionsSyncJob, SendEmailWithPdfJob, SendEmailNotificationJob, ApprovalCanceledNotification, ApprovalDecidedNotification, ApprovalPendingNotification (+21 more)
...
### Community 12 - "User"
Cohesion: 0.03
Nodes (19): BackupDatabaseJob, User, UserProvider, performBackup(), DatabaseNotification, Illuminate\Foundation\Queue\Queueable, Illuminate\Notifications\DatabaseNotification, AuthenticatedSessionControllerProviderCallbackTest (+11 more)
...
Cohesion: 0.07
Nodes (27): @babel/eslint-parser, concurrently, @eslint/js, eslint-plugin-jsdoc, globals, @inertiajs/react, devDependencies, @babel/eslint-parser (+19 more)
...
Cohesion: 0.17
Nodes (3): self, AdministratorSeeder, Illuminate\Support\Collection
...
Cohesion: 0.03
Nodes (22): SetupUserController, CompanyController, CompanyLogoController, LanguageController, TagController, RoleController, UserController, AppMiddleware (+14 more)

### Community 100 - "Account"
Cohesion: 0.08
Nodes (9): Illuminate\Contracts\Database\Eloquent\CastsAttributes, BadServicePropertyModel, NoServicePropertyModel, SubmitableCheckApprovalGuardTest, FormStatus, SubmitableCanCancelOverrideTestDocument, SubmitableCanCancelOverrideTrueTestDocument, SubmitableCanCancelTest (+1 more)
...
Cohesion: 0.16
Nodes (13): LanguageSwitcher, LOCALES, ToggleTheme, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem (+5 more)
...
## Knowledge Gaps
- **2463 isolated node(s):** `Overview`, `Tasks`, `Notes`, `Task Dependency Graph`, `Overview` (+2458 more)
...
- **Should `Illuminate\Notifications\Notification` be split into smaller, more focused modules?**
  _Cohesion score 0.03739330713995394 - nodes in this community are weakly interconnected._