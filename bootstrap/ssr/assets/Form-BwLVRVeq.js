...
function Form() {
  ...
  useEffect(() => {
    if (!data.return_date) {
      setData("return_date", (/* @__PURE__ */ new Date()).toISOString());
    }
  }, []);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(FormPageContent, { value: "detail", title: t("sales.salesReturn.detail"), children: /* @__PURE__ */ jsxs("div", { className: "grid gap-x-4 gap-y-4 md:grid-cols-2", children: [
      /* @__PURE__ */ jsx(
        FormInput,
        {
          name: "return_date",
          ...
          children: /* @__PURE__ */ jsx(
            ...
            {
              type: "datetime",
              value: data == null ? void 0 : data.return_date,
              onValueChange: (val) => {
                  ...
                  return {
                    ...
                    items: val == null ? void 0 : val.items.map((item) => {
                      return {
                        ...item,
                        id: generateRandom(8),
                        delivery_note_item_id: item == null ? void 0 : item.id,
                        source_warehouse: null,
                        target_warehouse: item == null ? void 0 : item.source_warehouse,
                        quantity: item == null ? void 0 : item.remaining_quantity
                      };
                    }),
    ...
    /* @__PURE__ */ jsxs(FormPageContent, { value: "detail", title: t("sales.salesReturn.items"), children: [
      /* @__PURE__ */ jsx(FormPageContentTitle, { className: "flex items-center justify-between gap-x-4", children: t("sales.salesReturn.items") }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-x-4 gap-y-4", children: /* @__PURE__ */ jsx(
        FormTable,
        {
          name: "items",
