...
import Form from "./Form-iKX2FHPC.js";
...
function Show({ printTemplate }) {
  ...
  return /* @__PURE__ */ jsx(
    FormPage,
    {
      ...
      controls: () => {
        return /* @__PURE__ */ jsx(Button, { type: "button", asChild: true, className: "h-8 w-fit", children: /* @__PURE__ */ jsxs(Link, { href: route("printTemplates.editor", printTemplate.id), children: [
