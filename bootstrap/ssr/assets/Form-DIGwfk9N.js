...
function Form() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(FormPageContent, { title: null, value: "detail", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-x-3 gap-y-4", children: [
      /* @__PURE__ */ jsx(FormInput, { required: true, label: t("finances.taxes.columns.name"), children: /* @__PURE__ */ jsx(
        Input,
        {
      ...
      /* @__PURE__ */ jsx(FormInput, { required: true, label: t("finances.taxes.columns.rate"), children: /* @__PURE__ */ jsx(
        CurrencyInput,
        {
          className: "text-left",
          value: data.rate,
