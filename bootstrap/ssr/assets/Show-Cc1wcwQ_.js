...
import Form from "./Form-BQq1yUQD.js";
...
function Show({ approvalScheme }) {
  return /* @__PURE__ */ jsx(FormPage, { name: "approvalScheme", title: approvalScheme.name, children: /* @__PURE__ */ jsx(Form, {}) });
}
export {
  Show as default
};
