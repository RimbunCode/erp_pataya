...
import { i as FormPageDiff } from "./checkbox-C_BEU5E4.js";
...
function ShowLog({ title, formPathname }) {
  ...
  return /* @__PURE__ */ jsx(FormPageDiff, { title, disabled: true, children: FormComponent ? /* @__PURE__ */ jsx(
    Suspense,
    {
