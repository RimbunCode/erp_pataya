...
import ItemForm from "./ItemForm-e6Hygw4w.js";
        ...
        cell({ dataRow, data: data2, setData: setData2, attributes }) {
          return /* @__PURE__ */ jsx(
            WarehouseLinkModel,
            {
              ...
              value: data2,
              onValueChange: (e) => setData2("target_warehouse", e),
              ...attributes
            }
          );
        }
        ...
        cell({ data: data2, setData: setData2, attributes, dataRow }) {
          return /* @__PURE__ */ jsx(
            Textarea,
            {
              disabled: !(dataRow == null ? void 0 : dataRow.item),
              value: data2,
              onValueChange: (val) => setData2("description", val),
              ...attributes
            }
          );
        }
                  ...
                  onValueChange: (val) => {
                    setData((prev) => {
                      ...
                      return {
                        ...
                        items: (_a = val == null ? void 0 : val.items) == null ? void 0 : _a.map((item) => {
                          return {
                            id: generateRandom(5),
