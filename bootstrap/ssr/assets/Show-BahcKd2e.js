...
function Show({ branch }) {
  ...
  return /* @__PURE__ */ jsx(
    FormPage,
    {
      ...
      badge: /* @__PURE__ */ jsx(Fragment, { children: branch.is_main_branch && /* @__PURE__ */ jsx("span", { className: "text-sm badge primary", children: t("core.branch.columns.is_main_branch") }) }),
