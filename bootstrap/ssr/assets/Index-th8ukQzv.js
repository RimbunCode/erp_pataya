...
import Form from "./Form-Dqr6B9s9.js";
      ...
      templateItem: ({ dataRow }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b gap-x-4 border-muted-foreground/25", children: [
        /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            className: "",
            children: [
              dataRow.two_way && /* @__PURE__ */ jsx("span", { className: "mb-1 -ml-2 text-xs badge primary", children: t("inventory.itemAlternative.columns.two_way") }),
              /* @__PURE__ */ jsx("p", { className: "text-base font-medium text-left", children: dataRow.item_code }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-left text-muted-foreground", children: dataRow.alternative_code })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
