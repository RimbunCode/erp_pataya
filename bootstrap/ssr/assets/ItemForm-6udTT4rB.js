...
import { g as FormPageContent } from "./checkbox-C_BEU5E4.js";
...
function ItemForm({ getColumn }) {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(FormPageContent, { value: "detail", title: null, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-4", children: [
    getColumn("item"),
    getColumn("description", { rows: 3 }),
    /* @__PURE__ */ jsxs("div", { className: "flex *:flex-1 gap-x-4", children: [
      getColumn("quantity"),
      getColumn("unit")
    ] }),
    getColumn("alternative")
  ] }) }) });
}
export {
  ItemForm as default
