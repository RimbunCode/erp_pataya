...
import Form from "./Form-CjyI6LgW.js";
      ...
      templateItem: ({ dataRow }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b gap-x-4 border-muted-foreground/25", children: [
        /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            className: "",
            children: [
              /* @__PURE__ */ jsx("p", { className: "text-base font-medium text-left text-muted-foreground", children: t(`inventory.category.types.${dataRow.type}`) }),
