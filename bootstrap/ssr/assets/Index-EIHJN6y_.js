...
import Form from "./Form-C_ygZCFM.js";
  ...
  return /* @__PURE__ */ jsx(
    DataTable2,
    {
      templateItem: ({ dataRow }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 border-b gap-x-4 border-muted-foreground/25", children: [
        /* @__PURE__ */ jsxs(Link, { as: "button", href: route("units.show", dataRow.id), className: "", children: [
          /* @__PURE__ */ jsx("p", { className: "text-base font-medium text-left text-muted-foreground", children: dataRow.group }),
          /* @__PURE__ */ jsxs("p", { className: "text-base font-medium text-left", children: [
            dataRow.name,
            " (",
            dataRow.code,
            ")"
        ...
        !dataRow.is_default && /* @__PURE__ */ jsx(
          Button,
          {
            variant: "destructive",
            size: "icon",
