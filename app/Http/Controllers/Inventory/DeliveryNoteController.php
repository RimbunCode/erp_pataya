                    ...
                    case 'internalOrder':
                        ...
                        if ($io) {
                            ...
                            $defaultData = [
                                ...
                                'reference_to'       => Permission::where('model', InternalOrder::class)->first(),
                                'items'              => $io->items
                                    ->filter(fn ($item) => $item->item->is_stock_item)
                                    ->map(fn ($item) => [
                                        'id'                 => Utils::generateRandom(5),
                    ...
                    case 'deliveryNote':
                        ...
                        if ($doTarget) {
                            ...
                            $defaultData = [
                                ...
                                'delivery_date'      => now(),
                                'reference_to'       => Permission::where('model', $doTarget->referenceable_type)->first(),
                                'customer'           => $doTarget->customer,
                                'customer_branch'    => $doTarget->customerBranch,
